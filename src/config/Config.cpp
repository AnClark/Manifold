...
std::string NodeConfig::saveNodeChain(std::vector<std::shared_ptr<Node>> &nodeChain, std::mutex& nodeChainMutex, toml::table outputConfig, std::string name, std::string description, std::string group)
{
    // 1. Create root table
    toml::table root;
