...
public:
    ...
    /**
     * @brief Returns whether the GLFW window has a pending close request.
     * @return `true` if the window should close; `false` if it should remain open
     *         or if GLFW failed to initialize.
     *
     * This reflects both close requests generated by the operating system, such
     * as clicking the window close button, and requests made through
