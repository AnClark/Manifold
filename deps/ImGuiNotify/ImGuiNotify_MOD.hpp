 ...
 * @date 07.07.2024
 * 
 * @note This ImGuiNotify (bundled with Manifold) has been modified and customized by AnClark Liu.
 */
...
#ifdef IMGUI_HAS_DOCK   /* [AnClark MOD] Check if using ImGui docking */
